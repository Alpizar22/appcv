...
TEXTS: dict[str, dict] = {
    "es": {
        ...
        # ── Improve CV mode ──
        "mode_improve": "✍️ Mejora tu CV",
        "impr_upload_label": "Sube tu CV en PDF",
        "impr_upload_help": "El PDF debe tener texto seleccionable (no escaneado).",
        "impr_jd_label": "Descripción del puesto *(opcional)*",
        "impr_jd_placeholder": "Pega la oferta de trabajo para recibir mejoras enfocadas en ese rol...",
        "impr_btn": "✨ Analizar y Mejorar",
        "impr_btn_caption": "Sube tu CV para habilitar el análisis.",
        "impr_spinner": "Analizando tu CV y generando mejoras…",
        "impr_spinner_pdf": "Generando reporte PDF…",
        "impr_no_results": "👈 Sube tu CV para ver las mejoras aquí",
        "impr_score_before": "Score actual",
        "impr_score_after": "Score estimado post-mejoras",
        "impr_gain": "+{n} puntos estimados",
        "impr_improvements_header": "### ✨ 5 Mejoras Accionables",
        "impr_accion_label": "Acción concreta:",
        "impr_weak_header": "### ⚠️ Secciones Débiles",
        "impr_keywords_header": "### 🔑 Palabras Clave Faltantes",
        "impr_format_header": "### 🎨 Formato y Presentación",
        "impr_summary_header": "### 📋 Resumen del diagnóstico",
        "impr_download": "📄 Descargar Reporte PDF",
        # Improve PDF
        "pdf_impr_title": "Reporte de Mejora de CV",
        "pdf_impr_score_before": "Score Actual",
        "pdf_impr_score_after": "Score Estimado Post-Mejoras",
        "pdf_impr_improvements": "5 Mejoras Accionables",
        "pdf_impr_accion": "Accion:",
        "pdf_impr_weak": "Secciones Debiles",
        "pdf_impr_keywords": "Palabras Clave Faltantes",
        "pdf_impr_format": "Formato y Presentacion",
        "pdf_impr_summary": "Resumen",
        "pdf_impr_footer": (
            "Generado por Analizador de CVs con IA  |  Powered by Claude (Anthropic)  |  "
            "Este reporte es orientativo y no reemplaza el criterio de un coach de carrera."
        ),
    },
    "en": {
        # Sidebar
        ...
        # ── Improve CV mode ──
        "mode_improve": "✍️ Improve your CV",
        "impr_upload_label": "Upload your CV in PDF",
        "impr_upload_help": "The PDF must have selectable text (not a scanned image).",
        "impr_jd_label": "Job description *(optional)*",
        "impr_jd_placeholder": "Paste the job offer to receive role-focused improvements...",
        "impr_btn": "✨ Analyze & Improve",
        "impr_btn_caption": "Upload your CV to enable analysis.",
        "impr_spinner": "Analyzing your CV and generating improvements…",
        "impr_spinner_pdf": "Generating PDF report…",
        "impr_no_results": "👈 Upload your CV to see improvements here",
        "impr_score_before": "Current score",
        "impr_score_after": "Estimated score after improvements",
        "impr_gain": "+{n} estimated points",
        "impr_improvements_header": "### ✨ 5 Actionable Improvements",
        "impr_accion_label": "Concrete action:",
        "impr_weak_header": "### ⚠️ Weak Sections",
        "impr_keywords_header": "### 🔑 Missing Keywords",
        "impr_format_header": "### 🎨 Format & Presentation",
        "impr_summary_header": "### 📋 Diagnosis summary",
        "impr_download": "📄 Download PDF Report",
        # Improve PDF
        "pdf_impr_title": "CV Improvement Report",
        "pdf_impr_score_before": "Current Score",
        "pdf_impr_score_after": "Estimated Score After Improvements",
        "pdf_impr_improvements": "5 Actionable Improvements",
        "pdf_impr_accion": "Action:",
        "pdf_impr_weak": "Weak Sections",
        "pdf_impr_keywords": "Missing Keywords",
        "pdf_impr_format": "Format & Presentation",
        "pdf_impr_summary": "Summary",
        "pdf_impr_footer": (
            "Generated by AI CV Analyzer  |  Powered by Claude (Anthropic)  |  "
            "This report is indicative and does not replace a career coach's judgement."
        ),
    },
}
...
SYSTEM_PROMPT_IMPROVE = {
    "es": """Eres un coach de carrera experto con más de 15 años optimizando CVs para procesos de selección.
Analiza el CV proporcionado y devuelve ÚNICAMENTE un objeto JSON válido (sin markdown, sin texto adicional) con esta estructura exacta:

{
  "score_antes": <entero 0-100, empleabilidad actual del CV>,
  "score_despues": <entero 0-100, empleabilidad estimada tras aplicar las mejoras>,
  "mejoras": [
    {
      "titulo": "<título corto de la mejora>",
      "descripcion": "<qué está mal o falta en el CV actual>",
      "accion": "<acción concreta y específica que debe tomar el candidato>"
    }
  ],
  "secciones_debiles": [<lista de nombres de secciones débiles o ausentes>],
  "palabras_clave_faltantes": [<lista de palabras clave o tecnologías relevantes que no aparecen>],
  "recomendacion_formato": "<párrafo con consejos de formato, diseño y presentación visual>",
  "resumen": "<2 oraciones resumiendo el estado actual y el impacto esperado de las mejoras>"
}

Devuelve exactamente 5 mejoras, ordenadas de mayor a menor impacto. Responde en español.
Si se incluye una descripción de puesto, enfoca las mejoras y palabras clave en ese rol específico.""",

    "en": """You are an expert career coach with over 15 years of experience optimizing CVs for hiring processes.
Analyze the provided CV and return ONLY a valid JSON object (no markdown, no additional text) with this exact structure:

{
  "score_antes": <integer 0-100, current CV employability score>,
  "score_despues": <integer 0-100, estimated score after applying improvements>,
  "mejoras": [
    {
      "titulo": "<short improvement title>",
      "descripcion": "<what is wrong or missing in the current CV>",
      "accion": "<concrete and specific action the candidate should take>"
    }
  ],
  "secciones_debiles": [<list of weak or missing section names>],
  "palabras_clave_faltantes": [<list of relevant keywords or technologies not present>],
  "recomendacion_formato": "<paragraph with format, design and visual presentation advice>",
  "resumen": "<2 sentences summarizing the CV state and expected improvement impact>"
}

Return exactly 5 improvements, ordered from highest to lowest impact. Respond in English.
If a job description is included, focus improvements and keywords on that specific role.""",
}
...
def improve_cv(cv_text: str, job_description: str, lang: str, t: dict) -> Optional[dict]:
    """Send CV to Claude for improvement analysis. Returns structured JSON."""
    api_key = os.getenv("ANTHROPIC_API_KEY")
    if not api_key:
        st.error(t["err_no_api_key"])
        return None
    ...
    try:
        response = client.messages.create(
            model=MODEL,
            max_tokens=2048,
            system=SYSTEM_PROMPT_IMPROVE[lang],
            messages=[{"role": "user", "content": content}],
        )
    except anthropic.AuthenticationError:
        st.error(t["err_invalid_api"])
...
def generate_improvement_pdf(result: dict, t: dict) -> bytes:
    """Generate a PDF report from the CV improvement analysis."""
    from fpdf import FPDF  # type: ignore

    ensure_fonts()
    use_unicode = os.path.exists(FONT_REG) and os.path.exists(FONT_BOLD)

    score_antes   = int(result.get("score_antes") or 0)
    score_despues = int(result.get("score_despues") or 0)
    mejoras       = result.get("mejoras") or []
    secciones     = result.get("secciones_debiles") or []
    keywords      = result.get("palabras_clave_faltantes") or []
    formato       = result.get("recomendacion_formato") or ""
    ...
    def _s(text) -> str:
        ...
        text = (text
                ...
                .replace("\u2713", "OK").replace("\u2714", "OK").replace("\u26a0", "!")
                .replace("\u2605", "*").replace("\u2019", "'").replace("\u2018", "'")
                .replace("\u201c", '"').replace("\u201d", '"')
                .replace("\u2013", "-").replace("\u2014", "-").replace("\u2026", "..."))
        return "".join(c if ord(c) < 256 else "?" for c in text)

    def section(title: str, color=(37, 99, 235)):
        pdf.set_fill_color(*color)
        pdf.set_text_color(255, 255, 255)
        pdf.set_font(FN, "B", 11)
        pdf.cell(0, 8, _s(title), fill=True)
        pdf.set_text_color(20, 20, 20)
        pdf.ln(10)
    ...
    pdf.cell(0, 14, _s(t["pdf_impr_title"]), fill=True, align="C")
    pdf.ln(8)

    # ── Scores ──
    pdf.set_text_color(20, 20, 20)
    sc_col = (40, 167, 69) if score_despues >= 75 else (253, 126, 20) if score_despues >= 50 else (220, 53, 69)
    for label, score, bar_color in [
        (t["pdf_impr_score_before"], score_antes,   (108, 117, 125)),
        (t["pdf_impr_score_after"],  score_despues, sc_col),
    ]:
        pdf.set_font(FN, "B", 10)
        pdf.cell(0, 5, _s(f"{label}: {score}/100"))
        pdf.ln(6)
        ...
        if filled > 0:
            ...
            pdf.rect(bx, by, filled, 4, "F")
        pdf.set_y(by + 9)
    pdf.ln(4)

    # ── Summary ──
    section(t["pdf_impr_summary"])
    body(resumen)
    pdf.ln(3)

    # ── 5 improvements ──
    section(t["pdf_impr_improvements"])
    for i, m in enumerate(mejoras[:5], 1):
        pdf.set_font(FN, "B", 10)
        pdf.cell(0, 5, _s(f"{i}. {m.get('titulo', '')}"))
        pdf.ln(6)
        body(m.get("descripcion", ""))
        pdf.set_font(FN, "B", 9)
        pdf.set_text_color(37, 99, 235)
        pdf.multi_cell(0, 4, _s(f"{t['pdf_impr_accion']} {m.get('accion', '')}"))
        pdf.set_text_color(20, 20, 20)
        pdf.ln(5)
    pdf.ln(2)
    ...
    # ── Weak sections ──
    if secciones:
        section(t["pdf_impr_weak"], color=(220, 53, 69))
        for s in secciones:
            body(f"- {s}")
        pdf.ln(2)
    ...
    # ── Missing keywords ──
    if keywords:
        section(t["pdf_impr_keywords"], color=(253, 126, 20))
        body(", ".join(keywords))
        pdf.ln(2)

    # ── Format recommendation ──
    section(t["pdf_impr_format"], color=(75, 85, 99))
    body(formato)
    pdf.ln(2)
    ...
    pdf.set_font(FN, "", 8)
    pdf.set_text_color(150, 150, 150)
    pdf.multi_cell(0, 4, _s(t["pdf_impr_footer"]), align="C")
...
# ══════════════════════════════════════════════════════════════════════════════
with tab_improve:
    impr_left, impr_right = st.columns([1, 1], gap="large")

    with impr_left:
        impr_file = st.file_uploader(
            t["impr_upload_label"],
            type=["pdf"],
            help=t["impr_upload_help"],
            key="impr_file",
        )
        st.caption(t["upload_caption"])

        impr_jd = st.text_area(
            t["impr_jd_label"],
            height=150,
            placeholder=t["impr_jd_placeholder"],
            key="impr_jd",
        )
        ...
        impr_btn = st.button(
            t["impr_btn"],
            type="primary",
            disabled=impr_file is None,
            use_container_width=True,
        )
        if not impr_file:
            st.caption(t["impr_btn_caption"])

    # ── Improvement analysis on button click ──────────────────────────────────
    if impr_btn and impr_file:
        raw_bytes = impr_file.read()
        ...
        if not cv_text:
            ...
            with st.spinner(t["impr_spinner"]):
                impr_result = improve_cv(cv_text, impr_jd, st.session_state.lang, t)

            if impr_result is not None:
                consume_key(st.session_state.access_key)

                with st.spinner(t["impr_spinner_pdf"]):
                    impr_pdf = generate_improvement_pdf(impr_result, t)

                st.session_state.improve_result = impr_result
                st.session_state.improve_pdf    = impr_pdf

    # ── Improvement results ───────────────────────────────────────────────────
    with impr_right:
        impr_result = st.session_state.improve_result
        ...
        if impr_result is None:
            ...
            score_antes   = int(impr_result.get("score_antes") or 0)
            score_despues = int(impr_result.get("score_despues") or 0)
            gain          = score_despues - score_antes
            mejoras       = impr_result.get("mejoras") or []
            secciones     = impr_result.get("secciones_debiles") or []
            keywords      = impr_result.get("palabras_clave_faltantes") or []
            formato       = impr_result.get("recomendacion_formato") or ""
            resumen       = impr_result.get("resumen") or ""
            ...
            # ── Summary ──
            st.markdown(t["impr_summary_header"])
            st.info(resumen)

            # ── 5 improvements ──
            st.markdown(t["impr_improvements_header"])
            for i, m in enumerate(mejoras[:5], 1):
                titulo = m.get("titulo", "")
            ...
            # ── Weak sections + Missing keywords side by side ──
            if secciones or keywords:
                w1, w2 = st.columns(2)
                with w1:
                    if secciones:
                        st.markdown(t["impr_weak_header"])
                        for s in secciones:
                            st.warning(s)
                with w2:
                    if keywords:
            ...
            # ── Format recommendation ──
            if formato:
                st.markdown(t["impr_format_header"])
                st.info(formato)

            # ── Download PDF ──
            st.divider()
            st.download_button(
                label=t["impr_download"],
                data=st.session_state.improve_pdf,
                file_name="mejora_cv.pdf",
                mime="application/pdf",
                use_container_width=True,
                type="primary",
            )
